            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  getCommonButton(baseTheme, () {}, "Specification Remarks",
                      width: 300, backGroundColor: Colors.blueAccent),
                  SizedBox(
                    height: 10,
                  ),
                  getCommonButton(baseTheme, () {
                    //QuotationSpecificationAddEditScreen
                    navigateTo(context, SpecificationListScreen.routeName,
...
*/
  ...
  TotalAmountCalculation() async {
    ProductCalculationModel productoutparam =
        productCalculation.funCalculateProduct(
      UnitQuantity: 1,
      TaxType: int.parse(_taxTypeController.text),
