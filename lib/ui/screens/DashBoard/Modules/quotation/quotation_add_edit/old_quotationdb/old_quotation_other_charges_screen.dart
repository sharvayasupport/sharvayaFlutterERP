...
class _OldQuotationOtherChargeScreenState
  ...
  void initState() {
    ...
    _ISCalculation = widget.arguments.ISCalculation;
            ...
            child: SingleChildScrollView(
              ...
              child: Form(
                ...
                child: Column(children: [
                  ...
                  _ISCalculation == "Calculation" //"Calculation"
                      ? Container()
                      : Column(
                          children: [
                            SizedBox(
