...
class SearchDestinationScreen extends BaseStatefulWidget {
  static const routeName = '/SearchDestinationScreen';
...
class _SearchDestinationScreenState extends BaseState<SearchDestinationScreen>
  ...
  Widget buildBody(BuildContext context) {
    return Column(
      children: [
        NewGradientAppBar(
          title: Text('Search Destination Details'),
          gradient:
