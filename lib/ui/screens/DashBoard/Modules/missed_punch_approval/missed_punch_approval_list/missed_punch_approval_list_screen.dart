  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => _leaveRequestScreenBloc
        ..add(MissedPunchApprovalListCallEvent(MissedPunchApprovalListRequest(
            ApprovalStatus: edt_FollowupStatus.text,
            LoginUserID: LoginUserID,
            CompanyId: CompanyID))),
              ...
              Expanded(
                child: RefreshIndicator(
                  onRefresh: () async {
                    ...
                    _leaveRequestScreenBloc.add(
                        MissedPunchApprovalListCallEvent(
                            MissedPunchApprovalListRequest(
                                ApprovalStatus: edt_FollowupStatus.text,
                                LoginUserID: LoginUserID,
                                CompanyId: CompanyID)));
                        ...
                        _leaveRequestScreenBloc.add(
                            MissedPunchApprovalSaveRequestCallEvent(
                                ...
                                MissedPunchApprovalSaveRequest(
                                    ApprovalStatus: _leaveRequestListResponse
                                        .details[index].approvalStatus,
                                    CompanyId: CompanyID,
                                    LoginUserID: LoginUserID)));
