...
import 'package:soleoserp/models/common/so_other_charge_temp.dart';
...
class SalesOrderOtherChargesScreenArguments {
  int StateCode;
  String HeaderDiscFromAddEditScreen;
  SalesOrderDetails editModel;

  SalesOrderOtherChargesScreenArguments(
      this.StateCode, this.editModel, this.HeaderDiscFromAddEditScreen);
}

class SalesOrderOtherChargeScreen extends BaseStatefulWidget {
  static const routeName = '/SalesOrderOtherChargeScreen';
  final SalesOrderOtherChargesScreenArguments arguments;

  SalesOrderOtherChargeScreen(this.arguments);

  @override
  _SalesOrderOtherChargeScreenState createState() =>
      _SalesOrderOtherChargeScreenState();
}

class _SalesOrderOtherChargeScreenState
    extends BaseState<SalesOrderOtherChargeScreen>
...
*/
  ...
  Widget buildBody(BuildContext context) {
    return WillPopScope(
      ...
      child: Column(
        children: [
          getCommonAppBar(context, baseTheme, "SalesOrder Charges",
...
*/
  ...
  void PushAllOtherChargesToDb() async {
   ...
   if(arrTemp.isNotEmpty)
    ...
    SO_OtherChargeTemp qt_otherChargeTable = SO_OtherChargeTemp();
    ...
    await OfflineDbHelper.getInstance()
        .insertSalesOrderOtherCharge(SO_OtherChargeTable(
  ...
  void FetchDetailsOfOtherCharges() async {
    List<SO_OtherChargeTable> temp =
        await OfflineDbHelper.getInstance().getSalesOrderOtherCharge();
  ...
  Future<void> _onTapOfDeleteALLQuotationCharges() async {
    await OfflineDbHelper.getInstance().deleteALLSalesOrderOtherCharge();
  }
