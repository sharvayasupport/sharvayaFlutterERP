...
class AddSalesOrderProductScreenArguments {
  SalesOrderTable model;
  int StateCode;
  String HeaderDiscAmnt;

  AddSalesOrderProductScreenArguments(
...
class AddSalesOrderProductScreen extends BaseStatefulWidget {
  static const routeName = '/AddSalesOrderProductScreen';
  final AddSalesOrderProductScreenArguments arguments;

  AddSalesOrderProductScreen(this.arguments);

  @override
  _AddSalesOrderProductScreenState createState() =>
      _AddSalesOrderProductScreenState();
}

class _AddSalesOrderProductScreenState
    extends BaseState<AddSalesOrderProductScreen>
  ...
  void initState() {
    ...
    if (widget.arguments.model != null) {
      ...
      if (widget.arguments.model.DeliveryDate != "" ||
          widget.arguments.model.DeliveryDate != null) {
