...
class AddSalesBillProductListArgument {
  String quotation_No;
  String stateCode;
  String HeaderDiscAmnt;

  AddSalesBillProductListArgument(
      this.quotation_No, this.stateCode, this.HeaderDiscAmnt);
}

class SaleBillProductListScreen extends BaseStatefulWidget {
  static const routeName = '/SaleBillProductListScreen';
  final AddSalesBillProductListArgument arguments;
  SaleBillProductListScreen(this.arguments);
  @override
  _SaleBillProductListScreenState createState() =>
      _SaleBillProductListScreenState();
}

class _SaleBillProductListScreenState
    extends BaseState<SaleBillProductListScreen>
  ...
  Widget buildBody(BuildContext context) {
    return Scaffold(
      appBar: /*PreferredSizeWidget(getCommonAppBar(context, baseTheme, "Quotation Product List", showBack: true)),*/
        ...
        title: Text("SaleBill Product List"),
      ),
        ...
        children: [
          ...
          FloatingActionButton(
            ...
            onPressed: () async {
              ...
              await navigateTo(context, AddSaleBillProductScreen.routeName,
                  arguments: AddSaleBillProductScreenArguments(
  ...
  Future<void> _onTapOfDeleteContact(int index) async {
    await OfflineDbHelper.getInstance()
        .deleteSalesBillProduct(_productList[index].id);
    setState(() {
