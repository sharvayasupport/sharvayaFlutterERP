...
class AddSaleBillProductScreenArguments {
  SaleBillTable model;
  int StateCode;
  String HeaderDiscAmnt;

  AddSaleBillProductScreenArguments(
...
class AddSaleBillProductScreen extends BaseStatefulWidget {
  static const routeName = '/AddSaleBillProductScreen';
  final AddSaleBillProductScreenArguments arguments;

  AddSaleBillProductScreen(this.arguments);

  @override
  _AddSaleBillProductScreenState createState() =>
      _AddSaleBillProductScreenState();
}

class _AddSaleBillProductScreenState extends BaseState<AddSaleBillProductScreen>
