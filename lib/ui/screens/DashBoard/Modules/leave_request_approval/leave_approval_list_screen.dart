      ...
      child: BlocConsumer<LeaveRequestScreenBloc, LeaveRequestStates>(
        ...
        listenWhen: (oldState, currentState) {
          if (currentState is LeaveRequestDeleteCallResponseState ||
              currentState is LeaveApprovalSaveResponseState) {
            return true;
          }
          return false;
        },
                                  ...
                                  Container(
                                    ...
                                    child: DropdownButtonHideUnderline(
                                      child: DropdownButton(
                                        ...
                                        value: _leaveRequestListResponse
                                            .details[index].approvalStatus,
...
*/
  ...
  void _onTapOfEditCustomer(LeaveRequestDetails detail) {
    ...
    showCommonDialogWithTwoOptions(
        context, "Are you sure you want to Update Missed Punch ?",
  ...
  void _onLeaveApprovalSaveCallSucess(
    ...
    print("ResponseLeaveApproval : " + state.response.details[0].column2);
    /* navigateTo(buildContext123, LeaveRequestApprovalListScreen.routeName,
        clearAllStack: true);*/
    //Navigator.of(context).pop();
