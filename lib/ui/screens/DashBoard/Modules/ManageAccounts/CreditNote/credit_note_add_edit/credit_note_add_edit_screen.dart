...
import 'package:soleoserp/blocs/other/bloc_modules/CreditNote/credit_note_bloc.dart';
...
class CreditNoteAddEditScreen extends BaseStatefulWidget {
  static const routeName = "/CreditNoteAddEditScreen";

  @override
  _CreditNoteAddEditScreenState createState() =>
      _CreditNoteAddEditScreenState();
}

class _CreditNoteAddEditScreenState extends BaseState<CreditNoteAddEditScreen>
    with BasicScreen, WidgetsBindingObserver {
  CreditNoteBloc _creditNoteBloc;
  ...
  @override
  void initState() {
    _creditNoteBloc = CreditNoteBloc(baseBloc);
    super.initState();
  }

  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => _creditNoteBloc,
      child: BlocConsumer<CreditNoteBloc, CreditNoteStates>(
        builder: (BuildContext context, CreditNoteStates state) {
          return super.build(context);
        },
        buildWhen: (oldState, currentState) {
          return false;
        },
        listener: (BuildContext context, CreditNoteStates state) {
          return super.build(context);
        },
