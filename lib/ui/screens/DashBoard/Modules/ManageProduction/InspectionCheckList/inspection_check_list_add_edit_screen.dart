...
class InspectionCheckListAddEditScreen extends BaseStatefulWidget {
  static const routeName = 'InspectionCheckListAddEditScreen';

  @override
  InspectionCheckListAddEditScreenState createState() =>
      InspectionCheckListAddEditScreenState();
}

class InspectionCheckListAddEditScreenState
    extends BaseState<InspectionCheckListAddEditScreen>
  ...
  TextEditingController _consumption_date = TextEditingController();
  TextEditingController _rev_consumption_date = TextEditingController();
  TextEditingController _consumption_date_ID = TextEditingController();
  TextEditingController _customer_name = TextEditingController();
  TextEditingController _customer_name_ID = TextEditingController();
  TextEditingController _customer_order_no = TextEditingController();
  TextEditingController _customer_order_ID = TextEditingController();
  ...
  TextEditingController _select_inspection_type = TextEditingController();
  TextEditingController _select_inspection_type_ID = TextEditingController();
        ...
        children: [
          Row(
            children: [
              ...
              Flexible(
                  flex: 2,
                  child: customTextLabel("Consumption Date",
                      leftPad: 10.0, bottomPad: 2.0)),
            ],
          ),
          Row(
          ...
          Row(
            children: [
              Flexible(
                child:
                    customTextLabel("Order No.", leftPad: 9.0, bottomPad: 2.0),
              ),
              Flexible(
                flex: 2,
                child: customTextLabel("Employee Name",
          ...
          space(10.0, 0.0),
          customTextLabel("Inspection Type", leftPad: 9.0, bottomPad: 2.0),
          EditText(context,
              hint: "Select Inspection Type",
              inputTextStyle: TextStyle(fontSize: 14),
              controller: _select_inspection_type,
