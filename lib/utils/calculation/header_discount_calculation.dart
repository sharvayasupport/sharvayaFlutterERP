...
class HeaderDiscountCalculation {
  ...
  static List<double> funCalculateAccurabath(
    ...
    print("jdfdsf56" + "OnlyItemGST : " + hdnTotItemGST.toStringAsFixed(2) + " Basic Amnt : " +
        txtTotBasicAmt.toStringAsFixed(2) + " Other GST : " + hdnOthChrgGST1.toStringAsFixed(2) );
   ...
   double n = txtTotBasicAmt + Tot_otherChargeWithTax + Tot_otherChargeExcludeTax +txtTotGST ;
